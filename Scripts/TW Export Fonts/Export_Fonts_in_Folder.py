...
class ExportFontsInFolder:
    ...
    def convertFont(self, path=None):
        ...
        exportpath = (
            self.destFolder.rstrip(os.path.sep)
            + os.path.sep
            + relpath.lstrip(os.path.sep)
        )
...
class dlg_exportFontsInFolder(QtGui.QDialog):
    ...
    def pickSrcFolder(self):
        self.edt_srcFolder.setText(
            QtGui.QFileDialog.getExistingDirectory(
                None,
                "Choose source folder",
                self.edt_srcFolder.text,
                QtGui.QFileDialog.ShowDirsOnly | QtGui.QFileDialog.DontResolveSymlinks,
            )
        )

    def pickDestFolder(self):
        self.edt_destFolder.setText(
            QtGui.QFileDialog.getExistingDirectory(
                None,
                "Choose folder",
                self.edt_destFolder.text,
                QtGui.QFileDialog.ShowDirsOnly | QtGui.QFileDialog.DontResolveSymlinks,
            )
        )
